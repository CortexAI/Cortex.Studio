...
namespace Cortex.Studio.Modules.ProcessDesigner.Controls
{
    public class ConnectionBezierLine : Shape
    {
        ...
        public static readonly DependencyProperty X1Property = DependencyProperty.Register(
            "X1", typeof(double), typeof(ConnectionBezierLine),
        ...
        public static readonly DependencyProperty X2Property = DependencyProperty.Register(
            "X2", typeof(double), typeof(ConnectionBezierLine),
            new FrameworkPropertyMetadata(0.0, MetadataOptions));
        ...
        public static readonly DependencyProperty Y1Property = DependencyProperty.Register(
            "Y1", typeof(double), typeof(ConnectionBezierLine),
            new FrameworkPropertyMetadata(0.0, MetadataOptions));
        ...
        public static readonly DependencyProperty Y2Property = DependencyProperty.Register(
            "Y2", typeof(double), typeof(ConnectionBezierLine),
            new FrameworkPropertyMetadata(0.0, MetadataOptions));
                ...
                Figures =
                {
                    new PathFigure
                    {
                        ...
                        Segments =
                        {
                            new BezierSegment
                            {
                                Point1 = new Point(X1 + distance, Y1),
                                Point2 = new Point(X2 - distance, Y2),
